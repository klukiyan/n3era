    ...
    <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
      ...
      >
        ...
        <p class="text-xs text-gray-500 mt-3">
          Literally you probably haven't heard of them the things i'm bout to shoot into your inbox.
        </p>
      </div>
    </div>
  </form>
...
<script setup>
  ...
  const { data } = await useAsyncData('datausers', () => $fetch('https://erawadee.com/api/usersshow'))
  // await console.log(data)
  // async function getFromDB () {
  //   const result = await $fetch('tpvisionweb.eu/api/usersshow');
  //   const data = await data.value
